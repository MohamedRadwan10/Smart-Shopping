...
export default function NavBar() {
  ...
  return (
    <>
      <nav className=" fixed-top navbar navbar-expand-lg bg-main-light mb-5 px-2">
        <div className="container">
          <Link className="navbar-brand" to="/">
            <img src={logo} alt="Logo" width={40} draggable="false" />
          ...
          >
            ...
            <ul className="navbar-nav ms-auto  col-md-4 mb-2 mb-lg-0">
              {UserToken !== null ? (
                <>
                  <div className="row w-100 justify-content-between align-items-center px-1">
                    ...
                    <li className={`${"nav-link col-md-3 mx-3 "}`}>
                    ...
                    <li className="nav-item col-md-3 mt-1">
                      <button
                        onClick={() => Logout()}
                        className={`${Style.Btn}`}
                      >
                ...
                <>
                  <li
                    className={`${"nav-item position-relative"} ${Style.NAV}`}
                  >
